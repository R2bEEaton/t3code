...
const ComposerFooterPrimaryActions = memo(function ComposerFooterPrimaryActions(props: {
  ...
  canQueueComposerMessage: boolean;
  queueComposerMessageTitle: string;
  sendWhenDoneComposerMessageTitle: string;
  onPreviousPendingQuestion: () => void;
  onInterrupt: () => void;
  onImplementPlanInNewThread: () => void;
  onQueueComposerMessage: (target: "manual" | "sendWhenDone") => boolean;
}) {
  return (
    <>
      ...
      <ComposerPrimaryActions
        ...
        canQueueComposerMessage={props.canQueueComposerMessage}
        queueComposerMessageTitle={props.queueComposerMessageTitle}
        sendWhenDoneComposerMessageTitle={props.sendWhenDoneComposerMessageTitle}
        onPreviousPendingQuestion={props.onPreviousPendingQuestion}
        onInterrupt={props.onInterrupt}
        onImplementPlanInNewThread={props.onImplementPlanInNewThread}
        onQueueComposerMessage={props.onQueueComposerMessage}
      />
    </>
  );
});
...
export interface ChatComposerProps {
  ...
  onQueueComposerMessage: (target: "manual" | "sendWhenDone", text: string) => boolean;
...
export const ChatComposer = memo(
  forwardRef<ChatComposerHandle, ChatComposerProps>(function ChatComposer(props, ref) {
    const {
      ...
      gitCwd,
      keybindings,
      queueComposerMessageTitle,
      sendWhenDoneComposerMessageTitle,
      promptRef,
      composerImagesRef,
    ...
    const handleQueueComposerMessage = useCallback(
      (target: "manual" | "sendWhenDone") => {
        if (!canQueueComposerMessage) {
          return false;
        }
        const queued = onQueueComposerMessage(target, composerSendState.trimmedPrompt);
        if (!queued) {
          return false;
        }
    ...
    const onComposerCommandKey = (
      ...
      if (key === "Enter") {
        ...
        if (command === "chat.queue.sendWhenDone") {
          return handleQueueComposerMessage("sendWhenDone");
        }
        if (command === "chat.queue.enqueue") {
          return handleQueueComposerMessage("manual");
        }
      }
              ...
              >
                ...
                >
                  <ComposerFooterPrimaryActions
                    ...
                    canQueueComposerMessage={canQueueComposerMessage}
                    ...
                    onQueueComposerMessage={handleQueueComposerMessage}
                  />
                </div>
              </div>
            )}
