...
files:
  - url: R2-Code-9.9.9-smoke.0-arm64.zip
    sha512: arm64zip
    size: 125621344
  - url: R2-Code-9.9.9-smoke.0-arm64.dmg
    sha512: arm64dmg
    size: 131754935
path: R2-Code-9.9.9-smoke.0-arm64.zip
sha512: arm64zip
...
`,
  ...
  writeFileSync(
    ...
    `version: 9.9.9-smoke.0
files:
  - url: R2-Code-9.9.9-smoke.0-x64.zip
    sha512: x64zip
    size: 132000112
  - url: R2-Code-9.9.9-smoke.0-x64.dmg
    sha512: x64dmg
    size: 138148807
path: R2-Code-9.9.9-smoke.0-x64.zip
sha512: x64zip
...
try {
  ...
  assertContains(
    nightlyReleaseMetadata,
    "name=R2 Code Nightly 9.9.10-nightly.20260413.321 (abcdef123456)",
  ...
  assertContains(
    mergedManifest,
    "R2-Code-9.9.9-smoke.0-arm64.zip",
    "Merged manifest is missing the arm64 asset.",
  );
  assertContains(
    mergedManifest,
    "R2-Code-9.9.9-smoke.0-x64.zip",
